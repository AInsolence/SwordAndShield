...
#include "Kismet/BlueprintFunctionLibrary.h"
#include "ModularLibrary.generated.h"
...
struct MULTIPLAYER_01_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MULTIPLAYER_01_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MULTIPLAYER_01_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MULTIPLAYER_01_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
UCLASS()
class MULTIPLAYER_01_API UModularLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
    /**
